    ...
    *saveString += "###################################################\n\n";
    ...
    if ( ui->checkBoxMW->isChecked() == true ) {
        ...
        if ( ui->lineEditMWnSample->text() == "" ) {
            ...
            *errorString += "PREPROCESS: N-sample cannot be equal or greater than 2 [In the Preprocess Section - Melbourne-Wübbena Cycle-slip Detection].\n";
    ...
    if ( ui->checkBoxLI->isChecked() == true ) {
        ...
        } else if ( ui->lineEditLInSamples->text().toInt() < 3 && ui->lineEditLInSamples->text().toInt()>20 ) {
            *errorString += "PREPROCESS:N-sample must be between 3 and 20 [In the Preprocess Section - Geometry-free Cycle-slip Detection].\n";
