 ...
 *
 * Code Management Tool File Version: 5.1  Revision: 2
 * Date: 2018/01/12
 ***************************************************************************/
 ...
 *          gLAB v5.1.3
 * Release: 2018/01/19
 * Change Log: Removed links "ftp://serenad-public.cnes.fr/SERENAD0/FROM_NTMF/" in
 ...
 *             Changed ".??" regular expression in file explorer for ".[0-9][0-9]" in order to avoid other type
 *               files which are not related to GNSS appear if they have similar name extensions.
 ...
 *               space on the bottom.
 *             Fixed groupboxes in the right column not being aligned to the top in Windows and Mac.
...
void gLAB_GUI::setSBASmodellingDefaults() {
    ...
    ui->lineEditSwitchinCooltime->setText("20");
...
void gLAB_GUI::on_actionDGNSS_triggered() {
    ...
    ui->checkBoxExcludeDuringSmoothingConvergenceUser->setChecked(false);
    ui->checkBoxExcludeDuringSmoothingConvergenceRef->setChecked(true);
...
// Function to see SINEX standard web pae explanation
...
// Function to see SINEX Bias standard web pae explanation
...
// Function to see IONEX and troposhere stan
...
void gLAB_GUI::on_actionGNSS_Tutorial_Book_triggered() {
    QDesktopServices::openUrl(QUrl("http://www.gage.es/gnss_book"));
}

// Function to visit the GNSS Master Course website
void gLAB_GUI::on_actionMaster_triggered() {
    QDesktopServices::openUrl(QUrl("http://www.gage.es/tutorials"));
}

// Function to get the latest released version
void gLAB_GUI::on_actionCheck_for_updates_triggered() {
    QNetworkAccessManager manager;
    QNetworkReply *response = manager.get(QNetworkRequest(QUrl("http://www.gage.es/gLAB/version")));
    QEventLoop event;
    ...
    double rev = revisionaux.toInt();

    QMessageBox messageBox;
    if ( ver == 0 && rev == 0 ) {
        messageBox.critical(0, "Connection problem",
                            "Cannot connect to server.\nPlease, review your Internet conexion and try it again.\n");
        ...
        messageBox.setText(QString("<p align='left'><br>There is a new version available: gLAB v%1.%2.</br><br>Please check <a href='http://www.gage.es/gLAB/'>http://www.gage.es/gLAB/</a> to obtain it.</br><br></br>").arg(ver, 3, 'f', 1, '0').arg(rev));
        messageBox.exec();
    }
}
...
void gLAB_GUI::on_actionRINEXObsVersion_2_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>RINEX measurement files:<br>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/'>ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/</a><br>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/data/highrate/'>ftp://cddis.gsfc.nasa.gov/pub/gps/data/highrate/</a></p>"
...
void gLAB_GUI::on_actionRINEXObsVersion_3_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>RINEX measurement files:<br>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/'>ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/</a><br>"

                   "<p align='left'>RINEX measurement files (1 Hz):<br>"
                   "<a href='ftp://igs.bkg.bund.de/IGS/highrate_v3/'>ftp://igs.bkg.bund.de/IGS/highrate_v3/</a><br>"
                   "<a href='ftp://igs.bkg.bund.de/MGEX/highrate_v3/'>ftp://igs.bkg.bund.de/MGEX/highrate_v3/</a><br>"
...
void gLAB_GUI::on_actionRINEXNavVersion_2_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>All or Mixed constellation RINEX Navigation files:<br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/'>ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/</a></p>"
...
void gLAB_GUI::on_actionRINEXNavVersion_3_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>All or Mixed constellation RINEX Navigation files:<br>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/'>ftp://cddis.gsfc.nasa.gov/pub/gps/data/daily/</a><br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/'>ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/</a></p>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/2013/brdm/'>ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/2013/brdm/</a></p>"

                    "<p align='left'>GPS and QZSS Navigation files with LNAV and CNAV messages (unofficial RINEX version):<br>"
                    "<a href='ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/2014/cnav/'>ftp://cddis.gsfc.nasa.gov/gnss/data/campaign/mgex/daily/rinex3/2014/cnav/</a></p>");
    QGridLayout* layout = (QGridLayout*)msgBox.layout();
    layout->addItem(horizontalSpacer, layout->rowCount(), 0, 1, layout->columnCount());
    msgBox.exec();
}
...
void gLAB_GUI::on_actionPrecise_Files_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>Precise orbits and clocks (SP3, CLK and SINEX files):<br>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/products/'>ftp://cddis.gsfc.nasa.gov/pub/gps/products/</a><br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/glonass/products/'>ftp://cddis.gsfc.nasa.gov/pub/glonass/products/</a><br>"
                   ...
                   "<a href='ftp://igs.ign.fr/pub/igs/products/mgex/'>ftp://igs.ign.fr/pub/igs/products/mgex/</a></p>"

                   "<p align='left'>SINEX files:<br>"
                   "<a href='ftp://ftp.gfz-potsdam.de/GNSS/metadata/station/snx/'>ftp://ftp.gfz-potsdam.de/GNSS/metadata/station/snx/<a></p>");
...
void gLAB_GUI::on_actionOther_Files_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'><p align='left'>ANTEX files (antenna corrections):<br>"
                   ...
                   "<a href='ftp://ftp.gfz-potsdam.de/GNSS/metadata/satellite/ANTEX/'>ftp://ftp.gfz-potsdam.de/GNSS/metadata/satellite/ANTEX/</a></p>"

                   "<p align='left'>IONEX files (ionosphere):<br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/products/ionex/'>ftp://cddis.gsfc.nasa.gov/pub/gps/products/ionex/</a></p>"

                   "<p align='left'>ZTD files (troposphere):<br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/products/troposphere/new/'>ftp://cddis.gsfc.nasa.gov/pub/gps/products/troposphere/new/</a></p>"
                   ...
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/products/mgex/dcb/'>ftp://cddis.gsfc.nasa.gov/pub/gps/products/mgex/dcb/</a></p>"

                   "<p align='left'>SINEX BIAS OSB files (multiconstellation absolute DCBs):<br>"
                   "<a href='ftp://cddis.gsfc.nasa.gov/pub/gps/products/mgex/'>ftp://cddis.gsfc.nasa.gov/pub/gps/products/mgex/</a></p>"

                   "<p align='left'>GPS Receiver types:<br>"
                   "<a href='ftp://sideshow.jpl.nasa.gov/pub/gipsy_products/gipsy_params/GPS_Receiver_Types.gz'>ftp://sideshow.jpl.nasa.gov/pub/gipsy_products/gipsy_params/GPS_Receiver_Types.gz</a></p>"
...
void gLAB_GUI::on_actionRefStations_Spain_triggered() {
    ...
    msgBox.setMinimumWidth(700);
    msgBox.setText("<span style='font-weight:normal'><p align='left'>Cartographic and Geologic Institute of Catalonia:<br>"
                   "<a href='ftp://geofons.icc.cat/rinex/horari_1s/'>ftp://geofons.icc.cat/rinex/horari_1s/</a></p>");
    QGridLayout* layout = (QGridLayout*)msgBox.layout();
    layout->addItem(horizontalSpacer, layout->rowCount(), 0, 1, layout->columnCount());
    msgBox.exec();
}
...
void gLAB_GUI::on_actionLists_of_NTRIP_servers_triggered() {
    ...
    msgBox.setText("<span style='font-weight:normal'>""<p align='left'>GDC (GNSS Data Center) server list:<br>"
                   ...
                   "<p align='left'>EGNOS NTRIP servers:<br>"
                   "<a href='https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_egnos-ip.htm'>https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_egnos-ip.htm</a></p>"

                   "<p align='left'>FAMOS NTRIP servers:<br>"
                   "<a href='https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_famos.htm'>https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_famos.htm</a></p>"

                   "<p align='left'>World-Wide NTRIP servers:<br>"
                   "<a href='https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_world-wide.htm'>https://igs.bkg.bund.de/root_ftp/NTRIP/streams/streamlist_world-wide.htm</a></p>");
    QGridLayout* layout = (QGridLayout*)msgBox.layout();
    layout->addItem(horizontalSpacer, layout->rowCount(), 0, 1, layout->columnCount());
    msgBox.exec();
}
...
void gLAB_GUI::on_actionReference_gLAB_triggered() {
    ...
    msgBox.setText(QString("<span style='font-weight:normal'><p align='left'>If you feel it is appropriate, you may consider paying us back by citing the following gLAB paper:<br><br>")+
                   QString("Sanz, J.; Rovira-Garcia, Adria.; Hernandez, M.; Juan, J.; Ventura-Traveset, J.; Lopez, C.; Hein, G. ") +
                   QString("<a href='http://gage6.upc.es/gAGE_WEB/papers/2012/FP_SA-133.pdf'>The ESA/UPC GNSS-Lab Tool (gLAB): An advanced educational and professional package for GNSS data processing and analysis.</a> ")+
                   QString("6th ESA Workshop on Satellite Navigation Technologies Multi-GNSS Navigation Technologies. Proceedings ISBN: 978-1-4673-2010-8, DOI: 10.1109/NAVITEC.2012.6423100. Noordwijk, the Netherlands. December 2012.</p>"));
    QGridLayout* layout = (QGridLayout*)msgBox.layout();
    layout->addItem(horizontalSpacer, layout->rowCount(), 0, 1, layout->columnCount());
    msgBox.exec();
}
                ...
                while ( !InputFile.atEnd() ) {
                    ...
                    if (QString::compare(option, "-help", Qt::CaseInsensitive)==0 || QString::compare(option, "--help", Qt::CaseInsensitive)==0 ) {
                        ...
                        if (ParametersList.count()<1) {
                            ...
                            checkConfigurationFileInputFilePaths("SBAS discontinuity risk plot", &warningString,&errorString,userInput);
                        }
                        warningString += "Parameter '" + option + "' is for SBAS plots mode. It has no effect in positioning mode.\n";
                ...
                while ( !InputFile.atEnd() ) {
                    ...
                    // MODEL SECTION
                        ...
                        if (ParametersList.count()<1) {
                            ...
                            warningString += "'NeQuick' ionosphere model in parameter '" + option + "' is not available. It was skipped.\n";
                        ...
                        if (ParametersList.count()<2) {
                            warningString += "Parameter '" + option + "' has missing values. It was skipped.\n";
                        } else if (userInputSingleSpace.section(" ", 0,0).replace(",","").toDouble()<0. || userInputSingleSpace.section(" ", 1,1).replace(",","").toDouble()<0.) {
